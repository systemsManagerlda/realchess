  ...
  const sections = [
    {
      id: "introducao",
      title: "1. Introdução",
      content: "O Real Chess Club ('nós', 'nosso' ou 'clube') está comprometido em proteger a sua privacidade. Esta Política de Privacidade explica como recolhemos, usamos, divulgamos e protegemos as suas informações pessoais quando visita o nosso site, se torna membro ou utiliza os nossos serviços. Ao utilizar os nossos serviços, você concorda com a recolha e uso de informações de acordo com esta política."
    },
    {
      id: "informacoes-coletadas",
      title: "2. Informações que Recolhemos",
      content: "Recolhemos informações que você nos fornece directamente, como nome, endereço de email, telefone, data de nascimento, rating de xadrez e histórico de participação em torneios. Também recolhemos automaticamente informações técnicas como endereço IP, tipo de navegador, páginas acedidas e tempo de visita quando interage com o nosso site. Para membros, podemos recolher informações adicionais como histórico de partidas, resultados em torneios e progresso nos treinamentos."
    },
    {
      id: "uso-informacoes",
      title: "3. Como Usamos as Suas Informações",
      content: "Utilizamos as suas informações para: (a) Gerir a sua associação e participação em torneios; (b) Comunicar novidades, eventos e resultados; (c) Melhorar os nossos serviços e experiência do utilizador; (d) Analisar desempenho e classificação de membros; (e) Cumprir obrigações legais e regulatórias; (f) Enviar materiais promocionais com o seu consentimento. Não utilizamos os seus dados para finalidades não autorizadas além das descritas nesta política."
    },
    {
      id: "compartilhamento",
      title: "4. Partilha de Informações",
      content: "Podemos partilhar as suas informações com: (a) A Federação Moçambicana de Xadrez (FMOX) para registo oficial de membros e torneios; (b) Organizadores de torneios para inscrições e resultados; (c) Parceiros de serviços que nos auxiliam na operação do clube; (d) Autoridades legais quando exigido por lei. Não vendemos, alugamos ou comercializamos as suas informações pessoais para terceiros para fins de marketing sem o seu consentimento explícito."
    },
    {
      id: "seguranca",
      title: "5. Segurança dos Dados",
      content: "Implementamos medidas de segurança técnicas e organizacionais para proteger as suas informações pessoais contra acesso não autorizado, alteração, divulgação ou destruição. Utilizamos criptografia SSL para transmissão de dados, firewalls, e controlos de acesso rigorosos. Apesar dos nossos esforços, nenhum método de transmissão pela internet ou armazenamento electrónico é 100% seguro. Em caso de violação de dados, notificaremos os afectados conforme exigido por lei."
    },
    {
      id: "direitos-usuario",
      title: "6. Os Seus Direitos",
      content: "Você tem direito a: (a) Aceder aos seus dados pessoais; (b) Corrigir informações incompletas ou incorrectas; (c) Solicitar a exclusão dos seus dados; (d) Revogar consentimento para tratamento de dados; (e) Solicitar portabilidade dos dados; (f) Opor-se a tratamentos específicos. Para exercer os seus direitos, entre em contacto pelo email privacidade@realchess.co.mz. Responderemos às suas solicitações em até 30 dias."
    },
    {
      id: "cookies",
      title: "7. Cookies e Tecnologias Similares",
      content: "Utilizamos cookies para melhorar a sua experiência: (a) Cookies essenciais: necessários para funcionamento do site; (b) Cookies de desempenho: analisam como você usa o site; (c) Cookies funcionais: lembram as suas preferências; (d) Cookies de publicidade: para conteúdo relevante. Você pode controlar os cookies nas configurações do seu navegador. A desactivação de cookies pode afectar a funcionalidade de algumas áreas do site."
    },
    {
      id: "dados-menores",
      title: "8. Dados de Menores",
      content: "Oferecemos programas para crianças e adolescentes. Para menores de 18 anos, exigimos o consentimento dos pais ou responsáveis legais para recolha e tratamento de dados. Os responsáveis têm acesso total às informações dos seus dependentes e podem solicitar modificações ou exclusão a qualquer momento. Não recolhemos intencionalmente dados de menores sem consentimento parental."
    },
    {
      id: "alteracoes",
      title: "9. Alterações nesta Política",
      content: "Podemos actualizar esta Política de Privacidade periodicamente. Notificaremos sobre alterações significativas por email ou através de um aviso no nosso site. A versão actualizada entrará em vigor na data indicada como 'Última actualização'. Recomendamos rever esta política regularmente para se manter informado sobre como protegemos as suas informações."
    },
    {
      id: "contato",
      title: "10. Contacto",
      content: "Se tiver dúvidas sobre esta Política de Privacidade ou sobre como tratamos os seus dados, entre em contacto connosco:",
      contact: {
        email: "privacidade@realchess.co.mz",
        phone: "+258 84 000 0000",
        address: "Bairro das Mahotas, Maputo - Moçambique",
        responsible: "Encarregado de Protecção de Dados: Dr. Carlos Mendes"
      }
    }
  ];
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className={`
              ...
              ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}
            `}>
              A sua privacidade é importante para nós. Leia atentamente como protegemos os seus dados
            </p>
            <div className={`
          ...
          `}>
            <p className="text-gray-300 text-sm leading-relaxed">
              Ao utilizar os nossos serviços, você concorda com os termos desta Política de Privacidade. 
              Se você não concordar com qualquer parte desta política, por favor, não utilize os nossos serviços.
            </p>
          </div>
          ...
          `}>
            <p className="text-xs text-gray-500">
              🏆 Real Chess Club - Comprometidos com a protecção dos seus dados desde 2019
            </p>
          </div>
        </div>
      </main>
